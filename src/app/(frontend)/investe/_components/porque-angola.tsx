...
import { Building2, ChevronLeft, ChevronRight, Factory, Globe, Home, Leaf, Zap } from 'lucide-react'
          ...
          >
            <CarouselContent className="-ml-6 h-full p-3">
              {investmentSectors.map((sector, index) => (
                <CarouselItem key={sector.name} className="pl-6 sm:basis-1/2 md:basis-1/3 ">
...
export default PorqueAngolaCarousel
